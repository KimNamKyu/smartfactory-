...
namespace _20181207.Modules
{
    class Load
    {
        ...
        public EventHandler GetHandler(string viewName)
        {
            switch (viewName)
            {
                case "main":
                    return GetMainLoad;
                case "Insert":
                    return GetInsertLoad;
                case "Update":
                    return GetUpdateLoad;
                case "Delete":
                    return GetDeleteLoad;
                default:
                    return null;
            }
        }
        ...
        private void GetInsertLoad(object o, EventArgs a)
        {
            parentForm.Size = new Size(1000, 800);
            parentForm.FormBorderStyle = FormBorderStyle.FixedSingle;
            parentForm.MaximizeBox = false;
        ...
        private void GetUpdateLoad(object o, EventArgs a)
        {
            parentForm.Size = new Size(1000, 800);
            parentForm.FormBorderStyle = FormBorderStyle.FixedSingle;
            parentForm.MaximizeBox = false;
        ...
        private void GetDeleteLoad(object o, EventArgs a)
        {
            parentForm.Size = new Size(1000, 800);
            parentForm.FormBorderStyle = FormBorderStyle.FixedSingle;
            parentForm.MaximizeBox = false;
